...
dataset = numpy.loadtxt("./data/DetailDataset01.csv", delimiter=",")
# split into input (X) and output (Y) variables
X_train = dataset[0:300,1:8]
Y_train = dataset[0:300,0]
X_test = dataset[300:, 1:8]
Y_test = dataset[300:, 0]
# create model
model = Sequential()
model.add(Dense(12, input_dim=7, init='uniform'))
...
model.save("./models/t01_300_02.h5")
