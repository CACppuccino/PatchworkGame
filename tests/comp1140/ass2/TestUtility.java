...
public class TestUtility {
    ...
    static final String PATCH_CIRCLES[] = {
            ...
            "YTJQKfUZLOAFaPRWEMcNgSVXbBGCdeDHI",
            "EGRfOSCBWgFDeYAHbIJaKcQLMNPTUVZXd",
            "YUKGNCMRbJBQfZLeagVDcOAWXPdETFSHI"
    };
    ...
    static final String PLACEMENTS[] = {
            ...
            "aAGARAAAEADE..MACA....gAFBSABG.bBBAGCABhAAAdBFB.HCEBTCFAhAAAJCHBfEAAhABALECCOCHDAAHAFECDPFEBWCAGNEAABFHDeFGBDFIBhBIAYEBFQGADhCAA...",
            "HDCAJAAA.aCECKADCQFCBLAGB.MFAB..TBEA.hIBAZBAAXBFAGDAAOCHDhAIASAHBCDCDBDEDhBGAWEBDFEFDeHCAADAB.bAADIFDAcACENDIChEAAPFHBVEFB.EGCB.hEHA..fHEBDAAB",
            "XAGAEAAAFACDHAEA.UCEBGBDB.NADB.MAIB.RCABBDCBhAAAfDDBLEFAaACC.hDIADCHBOABHAAGAdFADSFDBhAEAYDGDbGFAQGFAeDCB.cGBDhCAAWHEGIFEAhAAA.JEBF."
    };

    static final int SCORES[] = {
            21, 7, 24, -19, -11, 3, 20, -1, 20, -10, -102, 7, 2, 0, 23, 9, -2, -2, 19, -6, 15, 8, -4, 24, 24, -4, 6, 6
    };

    static final boolean SEVEN_BY_SEVEN[] = {
            true, false, false, false, false, false, false, false, true, false, false, false, false, false, false, false, false, false, true, false, false, false, false, false, false, true, false, false
    };
    ...
    static final String INVALID_PLACEMENTS[] = {
            ...
            "aAGARAAAEADE..MACA....gAFBSABG.bBBAGCABhAAAdBFB.HCEBTCFAhAAAJCHBFEAAhABALECCOCHDAAHAFECDPFEBWCAGNEAABFHDeFGBDFIBhBIAYEBFQGADhCAA...",
            "HDCAJAAA.aCECKADCQFCBLAGB.MFAB..TBEA.hIBAZBAAXBFAGDAAOCHDhAIASAHBCDCDBDEDhBGA.WEBDFEFDeHCAADAB.bAADIFDAcACENDIChEAAPFHBVEFB.EGCB.hEHA..fHEBDAAB",
            "XAGAEAAAFACDHAEA.UCEBGBDB.NADB.MAIB.XAGARCABBDCBhAAAfDDBLEFAaACC.hDIADCHBOABHAAGAdFADSFDBhAEAYDGDbGFAQGFAeDCB.cGBDhCAAWHEGIFEAhAAA.JEBF."
    };
